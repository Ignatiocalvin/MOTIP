#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════
# RF-DETR Large + SAM Concept Bottleneck Training Script for PDestre
# ═══════════════════════════════════════════════════════════════════════════════
#
# Usage: Edit the CONFIGURATION section below, then submit with:
#   sbatch train_rf-detr_sam.sh
#
# This script trains the RF-DETR model with SAM concept bottleneck:
...
#   - RF-DETR uses DINOv2 backbone (higher memory usage)
#
# ═══════════════════════════════════════════════════════════════════════════════
...
#SBATCH --output=logs/rfdetr_sam_%j.out
#SBATCH --error=logs/rfdetr_sam_%j.err
...
SCRIPT_PATH="${SCRIPT_DIR}/train_rf-detr_sam.sh"
...
# ── RUN TRAINING ─────────────────────────────────────────────────────────────
echo "════════════════════════════════════════════════════════════════════"
echo " RF-DETR Large + SAM Concept Bottleneck Training"
